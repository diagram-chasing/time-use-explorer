...
wget https://github.com/Vonter/india-timeuse-survey/raw/refs/heads/main/data/individual_daily_schedule_full.parquet -O src/lib/assets/india_timeuse_survey.parquet
